...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
  ...
  private RuntimeTypeAdapterFactory(Class<?> baseType, String typeFieldName, boolean maintainType, Class<?> defaultType) {
   ...
   */
  public static <T> RuntimeTypeAdapterFactory<T> of(Class<T> baseType, String typeFieldName, boolean maintainType, Class<? extends T> defaultType) {
