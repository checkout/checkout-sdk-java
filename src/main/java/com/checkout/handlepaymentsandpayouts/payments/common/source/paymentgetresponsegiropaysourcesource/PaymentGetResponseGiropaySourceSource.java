...
public final class PaymentGetResponseGiropaySourceSource extends AbstractSource {
     ...
     */
    @Builder
    private PaymentGetResponseGiropaySourceSource(
        ...
        super(SourceType.PAYMENT_GET_RESPONSE_GIROPAY_SOURCE);
    ...
    public PaymentGetResponseGiropaySourceSource() {
        super(SourceType.PAYMENT_GET_RESPONSE_GIROPAY_SOURCE);
    }
