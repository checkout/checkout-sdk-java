...
import com.checkout.handlepaymentsandpayouts.flow.paymentsessionscomplete.enums.StorePaymentDetailsType;
import com.checkout.handlepaymentsandpayouts.flow.paymentsessionscomplete.requests.accountholder.AbstractAccountHolder;
...
public final class Googlepay {
    ...
    /**
     * Default: "disabled"
     * Specifies whether you intend to store the cardholder's payment details. If you set this field to enabled, you
