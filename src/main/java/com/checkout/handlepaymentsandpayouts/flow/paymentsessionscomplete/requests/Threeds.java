...
import com.checkout.handlepaymentsandpayouts.flow.paymentsessionscomplete.enums.ChallengeIndicatorType;
import com.checkout.handlepaymentsandpayouts.flow.paymentsessionscomplete.enums.ExemptionType;
...
public final class Threeds {
     ...
     * authentication being required. For processing channels created before October 12, 2022, the value will default
     * to false.
     */
    @Builder.Default
