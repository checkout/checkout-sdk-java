...
import com.checkout.handlepaymentsandpayouts.flow.paymentsessions.enums.MerchantInitiatedReasonType;
...
public final class Processing {
    ...
    /**
     * The payment for a merchant's order may be split, and the original order price indicates the transaction amount of
     * the entire order.
     */
