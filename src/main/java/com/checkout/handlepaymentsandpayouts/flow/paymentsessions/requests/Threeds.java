...
import com.checkout.handlepaymentsandpayouts.flow.paymentsessions.enums.ChallengeIndicatorType;
...
public final class Threeds {
    ...
    /**
     * Default: false Whether to process the payment as a 3D Secure payment. Payments where merchant_initiated is set to
     * true will be processed as 3DS Requestor Initiated.
     */
    @Builder.Default
    private Boolean enabled = false;

    /**
     * Default: false Applies only when 3ds.enabled is set to true. Set to true to attempt the payment without 3DS when
     * the issuer, card, or network doesn't support 3DS.
     */
    @Builder.Default
    ...
    /**
     * Default: "other" Specifies an exemption reason for the payment to not be processed using 3D Secure
    ...
    /**
     * Default: true Specifies whether to process the payment as 3D Secure, if authorization was soft declined due to
     * 3DS authentication being required. For processing channels created before October 12, 2022, the value will
     * default to false.
     */
    @Builder.Default
