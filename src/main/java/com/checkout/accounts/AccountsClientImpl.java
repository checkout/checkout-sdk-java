...
public class AccountsClientImpl extends AbstractClient implements AccountsClient {
    ...
    public CompletableFuture<OnboardEntityResponse> createEntity(final OnboardEntityRequest entityRequest) {
        ...
        return apiClient.postAsync(buildPath(ACCOUNTS_PATH, ENTITIES_PATH), sdkAuthorization(), OnboardEntityResponse.class, entityRequest, null);
    }

    @Override
    public CompletableFuture<OnboardEntityDetailsResponse> getEntity(final String entityId) {
        validateParams("entityId", entityId);
        return apiClient.getAsync(buildPath(ACCOUNTS_PATH, ENTITIES_PATH, entityId), sdkAuthorization(), OnboardEntityDetailsResponse.class);
    }
    ...
    public CompletableFuture<OnboardEntityResponse> updateEntity(final OnboardEntityRequest entityRequest, final String entityId) {
        ...
        return apiClient.putAsync(buildPath(ACCOUNTS_PATH, ENTITIES_PATH, entityId), sdkAuthorization(), OnboardEntityResponse.class, entityRequest);
    }
    ...
    public CompletableFuture<EmptyResponse> createPaymentInstrument(final AccountsPaymentInstrument accountsPaymentInstrument, final String entityId) {
        ...
        return apiClient.postAsync(buildPath(ACCOUNTS_PATH, ENTITIES_PATH, entityId, INSTRUMENTS_PATH), sdkAuthorization(), EmptyResponse.class, accountsPaymentInstrument, null);
    }
    ...
    public CompletableFuture<IdResponse> submitFile(final AccountsFileRequest accountsFileRequest) {
        ...
        return filesClient.submitFileAsync(FILES_PATH, sdkAuthorization(), accountsFileRequest, IdResponse.class);
    }
    ...
    public CompletableFuture<VoidResponse> updatePayoutSchedule(final String entityId, final Currency currency, final UpdateScheduleRequest updateScheduleRequest) {
        ...
        return apiClient.putAsync(buildPath(ACCOUNTS_PATH, ENTITIES_PATH, entityId, PAYOUT_SCHEDULES), sdkAuthorization(), VoidResponse.class, request);
    }

    @Override
    public CompletableFuture<GetScheduleResponse> retrievePayoutSchedule(final String entityId) {
        validateParams("entityId", entityId);
        return apiClient.getAsync(buildPath(ACCOUNTS_PATH, ENTITIES_PATH, entityId, PAYOUT_SCHEDULES), sdkAuthorization(), GetScheduleResponse.class);
    }
