...
public final class PaymentBankAccountDestination extends PaymentDestination {
    ...
    @Builder
    private PaymentBankAccountDestination(final AccountType accountType,
    ...
    public PaymentBankAccountDestination() {
        super(PaymentDestinationType.BANK_ACCOUNT);
    }
