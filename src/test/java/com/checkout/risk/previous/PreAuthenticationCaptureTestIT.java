package com.checkout.risk.previous;
...
class PreAuthenticationCaptureTestIT extends SandboxTestFixture {
    ...
    void shouldPreAuthenticate_customer() {
        ...
        final com.checkout.customers.previous.CustomerRequest customerRequest = com.checkout.customers.previous.CustomerRequest.builder()
    ...
    void shouldPreAuthenticate_id() {
        ...
        final CardTokenResponse cardToken = blocking(() -> previousApi.tokensClient().requestCardToken(cardTokenRequest));
    ...
    private PreAuthenticationAssessmentResponse testAuthenticationAssessmentRequest(final RiskPaymentRequestSource requestSource) {
        ...
        final PreAuthenticationAssessmentResponse response = blocking(() -> previousApi.riskClient().requestPreAuthenticationRiskScan(request));
    ...
    private void testPreCaptureAssessmentRequest(final RiskPaymentRequestSource requestSource, final String assessmentId) {
        ...
        final PreCaptureAssessmentResponse response = blocking(() -> previousApi.riskClient().requestPreCaptureRiskScan(request));
