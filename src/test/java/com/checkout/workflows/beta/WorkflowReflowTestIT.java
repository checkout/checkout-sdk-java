...
import com.checkout.workflows.beta.reflow.ReflowByEventsRequest;
...
class WorkflowReflowTestIT extends AbstractWorkflowTestIT {
    ...
    void shouldReflowByEvent() {
        ...
        assertNull(blocking(getApiV2().workflowsClient().reflowByEvent(paymentApprovedEvent.getId())));
    ...
    void shouldReflowBySubject() {
        ...
        assertNull(blocking(getApiV2().workflowsClient().reflowBySubject(payment.getId())));
    ...
    void shouldReflowByEventAndWorkflow() {
        ...
        assertNull(blocking(getApiV2().workflowsClient().reflowByEventAndWorkflow(
    ...
    void shouldReflowBySubjectAndWorkflow() {
        ...
        assertNull(blocking(getApiV2().workflowsClient().reflowBySubjectAndWorkflow(
                payment.getId(),
                createWorkflowResponse.getId()))
        );
    ...
    void shouldReflowByEvents() {
        ...
        assertNull(blocking(getApiV2().workflowsClient().reflow(request)));
    ...
    private SubjectEvent getSubjectEvent(final String subjectId) {
        ...
        final SubjectEventsResponse subjectEventsResponse = blocking(getApiV2().workflowsClient().getSubjectEvents(subjectId));
