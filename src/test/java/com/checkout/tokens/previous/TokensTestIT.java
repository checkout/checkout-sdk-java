package com.checkout.tokens.previous;
...
class TokensTestIT extends SandboxTestFixture {
    ...
    void shouldRequestCardToken() {
        ...
        final CardTokenResponse response = blocking(() -> previousApi.tokensClient().requestCardToken(request));

        assertNotNull(response);
        Assertions.assertEquals(TokenType.CARD, response.getType());
